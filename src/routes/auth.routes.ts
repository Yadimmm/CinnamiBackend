...
router.get('/access-events/all', verifyToken as unknown as RequestHandler, getAllAccessEvents as unknown as RequestHandler);
// Obtener eventos de acceso del usuario autenticado
router.get("/access-events/user", verifyToken as unknown as RequestHandler, getUserAccessEvents as unknown as RequestHandler);
